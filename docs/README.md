...
Target: OmniSequence: Transfinite **2.0.4-forge**, Minecraft **1.20.1**, Forge,
Java **17**, AE2 **15.4.10 through 15.x**, AppliedEnhancements **1.0.6-forge**.
The Mod ID remains `molecularmanipulator`.

Project documentation: [2.0.4 release notes](releases/2.0.4.md),
...
本文档对应 2.0.4-forge，批量投料 API 保持 v1；研究接口从 2.0.0 提供。模组 ID
仍为 `molecularmanipulator`，客户端和服务端都需要 AppliedEnhancements 1.0.6-forge。

项目文档：[2.0.4 更新说明](releases/2.0.4.md)、[中英 CurseForge 介绍](curseforge-description.md)、
