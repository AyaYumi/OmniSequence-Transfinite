...
This description covers **version 2.0.5 for Minecraft 1.21.1 / NeoForge / Java 21**. For other downloads, use the requirements and changelog attached to that file.
...
以下介绍对应 **2.0.5，Minecraft 1.21.1 / NeoForge / Java 21**。其他下载文件的版本、前置和功能请以各自说明为准。
...
替换 JAR 前完全关闭客户端／服务器，双端使用相同版本，每个实例保留一个启用的万象构序 JAR。如果原配置超过 300 页样板，请先迁出第 300 页之后的样板，再安装 2.0.5；原先位于构筑井外围服务位置的方块，应按当前投影迁移。
