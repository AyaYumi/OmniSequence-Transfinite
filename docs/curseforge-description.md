...
This description covers **version 2.0.3-forge for Minecraft 1.20.1 / Forge / Java 17**. For other downloads, use the requirements and changelog attached to that file.
...
The Forge build uses native Minecraft/AE2 controls and does not require LDLib2.

## Requirements and installation

Install the matching **Minecraft 1.20.1 Forge** files on both client and server:
...
**Advanced AE for Forge 1.20.1** is optional for the base mod and required for the default Omni-Computation research branch and nexus recipe. Optional integrations also include JEI, ExtendedAE Plus and AE2WTLib-compatible terminals.
...
- [Forge changelog](https://github.com/AyaYumi/OmniSequence-Transfinite/blob/1.20.1-forge/CHANGELOG.md)
- [Integration APIs and recipe limitations](https://github.com/AyaYumi/OmniSequence-Transfinite/blob/1.20.1-forge/docs/README.md)
...
以下介绍对应 **2.0.3-forge，Minecraft 1.20.1 / Forge / Java 17**。其他下载文件的版本、前置和功能请以各自说明为准。
...
Forge 版使用原生 Minecraft/AE2 控件，不需要 LDLib2。

## 前置与安装

客户端和服务端均需安装匹配的 **Minecraft 1.20.1 Forge** 文件：
...
**Advanced AE for Forge 1.20.1** 对基础模组为可选，对默认万物演算研究分支和超限算枢配方为必要条件。其他可选兼容包括 JEI、ExtendedAE Plus 和兼容 AE2WTLib 的终端。
...
- [Forge 更新日志](https://github.com/AyaYumi/OmniSequence-Transfinite/blob/1.20.1-forge/CHANGELOG.md)
- [集成 API 与配方限制](https://github.com/AyaYumi/OmniSequence-Transfinite/blob/1.20.1-forge/docs/README.md)
- [AppliedEnhancements](https://github.com/AyaYumi/AppliedEnhancements)
