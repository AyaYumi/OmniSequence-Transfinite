...
public final class MatterFabricationGuideRecipes implements RecipeTypeMappingSupplier {
    ...
    public static LytBlock create(RecipeHolder<MatterFabricationRecipe> holder) {
        ...
        if (!recipe.ingredients().isEmpty()) {
            ...
            var inputs = new LytSlotGrid(columns, Math.ceilDiv(recipe.ingredients().size(), columns));
