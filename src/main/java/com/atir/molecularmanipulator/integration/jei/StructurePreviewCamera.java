...
final class StructurePreviewCamera {
    ...
    void zoomAt(double scroll, double xFromCenter, double yFromCenter) {
        double next = com.atir.molecularmanipulator.util.MathCompat.clamp(zoom * Math.pow(1.15, com.atir.molecularmanipulator.util.MathCompat.clamp(scroll, -10, 10)), 0.2, 12.0);
