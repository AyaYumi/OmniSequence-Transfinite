...
public final class MatterFabricationPatternAssemblyMenu extends AEBaseMenu {
    ...
    public static final MenuType<MatterFabricationPatternAssemblyMenu> TYPE = ForgeMenuTypeFactory.create(MolecularManipulator.id("matter_fabrication_pattern_assembly"), MatterFabricationPatternAssemblyMenu::new, MatterFabricationPatternAssemblyBlockEntity.class);
    ...
    private MatterFabricationPatternAssemblyMenu(int id, Inventory playerInventory,
        ...
        for (int slot = 0; slot < MatterFabricationPatternAssemblyBlockEntity.PATTERN_SLOTS; slot++) {
            var patternSlot = new RestrictedInputSlot(
                    RestrictedInputSlot.PlacableItemType.ENCODED_PATTERN, patterns, slot);
