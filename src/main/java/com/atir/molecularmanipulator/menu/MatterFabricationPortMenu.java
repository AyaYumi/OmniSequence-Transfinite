...
public final class MatterFabricationPortMenu extends AEBaseMenu {
    ...
    public static final MenuType<MatterFabricationPortMenu> TYPE = ForgeMenuTypeFactory.create(MolecularManipulator.id("matter_fabrication_port"), MatterFabricationPortMenu::new, MatterFabricationPortBlockEntity.class);
    ...
    private void transferFluid(Integer requestedTank, boolean bidirectional) {
        ...
        var playerInventory = player.getCapability(ForgeCapabilities.ITEM_HANDLER).orElse(null);
