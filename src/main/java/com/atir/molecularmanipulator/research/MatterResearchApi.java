...
public final class MatterResearchApi {
    ...
    public static List<RecipeHolder<MatterResearchRecipe>> definitions(Level level) {
    ...
    public static boolean prerequisitesMet(MatterResearchRecipe research, List<RecipeHolder<MatterResearchRecipe>> available,
    ...
    public static int requiredPrerequisiteLevel(MatterResearchRecipe research, RecipeHolder<MatterResearchRecipe> prerequisite) {
    ...
    public static ProductionProfile productionProfile(MatterFabricationBlockEntity machine, RecipeHolder<MatterFabricationRecipe> recipe) {
    ...
    public static boolean canUseRecipe(MatterFabricationBlockEntity machine, RecipeHolder<MatterFabricationRecipe> recipe) {
    ...
    public static boolean isRecipeUnlocked(MatterFabricationBlockEntity machine, String recipeId) {
        ...
        return recipe != null && hasPermission(machine, id,
                recipe.value() instanceof MatterFabricationRecipe fabrication && fabrication.requiresResearch());
    }
