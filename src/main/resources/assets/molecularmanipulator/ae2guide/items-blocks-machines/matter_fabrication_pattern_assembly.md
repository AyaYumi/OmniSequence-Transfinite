...
3. Insert AE2 processing patterns matching well recipes, including exact item/fluid inputs and outputs. There are 36 pattern slots.
...
The interface has **Patterns**, **Input Buffer** and **Output Buffer** tabs. Item and fluid buffers have no fixed type-slot
limit; each AE key can hold up to 9,223,372,036,854,775,807 units, about 9.22E. Different item/fluid data creates distinct
